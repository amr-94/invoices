            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                    ...
                    <div class="dropdown-menu">
                        ...
                        @foreach (Auth::user()->unreadnotifications() as $notifications)
                            <div class="main-message-list chat-scroll">
                                <a href="{{ route('admin.show_notify',$notifications->id)}}" class="p-3 d-flex border-bottom">
                                    <div class="wd-90p">
                                        <div class="d-flex">
                                            <h5 class="mb-1 name">{{ $notifications->data['user'] }}</h5>
                                        </div>
                                        <p class="mb-0 desc">{{ $notifications->data['title'] }}.
                                        </p>
                                        <p class="time mb-0 text-left float-right mr-2 mt-2">{{ $notifications->created_at->diffForhumans() }}</p>
                                    </div>
                                </a>
                            </div>
                            @endforeach
                            <div class="text-center dropdown-footer">
                                <a href="{{ route('admin.notify') }}">VIEW ALL</a>
                            </div>
                    </div>
                </div>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ asset('user') }}/{{ Auth::user()->profile_photo }} "></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt=""
                                        src="{{ asset('user') }}/{{ Auth::user()->profile_photo }} "
                                        class=""></div>
                        ...
                        <a class="dropdown-item" href="{{ route('admin.show', Auth::user()->id) }}"><i
                                class="bx bx-user-circle"></i>Profile</a>
                        <a class="dropdown-item" href="{{ route('admin.edit', Auth::user()->id) }}"><i
                                class="bx bx-user-circle"></i>تعديل البيانات الشخصية</a>
