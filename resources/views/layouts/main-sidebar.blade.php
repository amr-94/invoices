            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ asset('user') }}/{{ Auth::user()->profile_photo }} "><span
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-morris')) }}">المدفوعة</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-flot')) }}">المدفوعة جزئيا</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-chartjs')) }}">الغير مدفوعة</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'darggablecards')) }}">تقرير العملاء</a>
                    </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'cards')) }}">قائمة المتسخدمين</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'darggablecards')) }}"> الصلاحيات</a>
                    </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('products.index') }}"> المنتجات</a>
