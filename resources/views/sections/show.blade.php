    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card mg-b-20">
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">تم اضافته بواسطة</th>
                ...
                <h2 class="text mb-3 text-danger" style="text-align: center">الفواتير الخاصة بهذا القسم</h2>
                <div class="table-responsive">
                    <table id="example" class="table key-buttons text-md-nowrap">
                        <thead>
                            <tr>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="sections/destroy" method="post">
                        ...
                        @csrf
                        <div class="modal-body">
                            <p>هل انت متاكد من عملية الحذف القسم؟</p><br>
                            <input type="hidden" name="id" id="id" value="">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="invoices/destroy" method="post">
                        ...
                        @csrf
                        <div class="modal-body">
                            <p>هل انت متاكد من عملية الحذف الفاتورة ؟</p><br>
                            <input type="hidden" name="id" id="id" value="">
                            <input class="form-control" name="invoice_number" id="invoice_number" type="numper"
                                readonly>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">الغاء</button>
...
@section('js')
    ...
    <script>
        ...
        // ============== حذف الفاتورة الخاصة بهذا القسم ============
        $('#modaldemo10').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget)
            var id = button.data('id')
            var invoice_number = button.data('invoice')
            var modal = $(this)
