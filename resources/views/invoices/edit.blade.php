    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                تعديل الفاتورة رقم  <span class="text text-success">  {{ $invoice->invoice_number }} </span></span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    <form action="{{ route('invoices.update',$invoice->id) }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="invoice_user" class="control-label">صاحب الفاتورة</label>
                                <input type="text" class="form-control" id="inputName" name="invoice_user"
                                    title="يرجي ادخال رقم الفاتورة" required value="{{ $invoice->invoice_user }}">
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select name="Status" class="form-control SlectBox" >
                                    <!--placeholder-->
                                        <option value=""  disabled>حالة الفاتورة</option>
                                        ...
                                        <option value="مدفوعة جزئيا" @if ($invoice->Status == "مدفوعة جزئيا")selected  @endif> مدفوعة جزئيا</option>
                                </select>
                            </div>
                                ...
                                <select name="Section" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    @foreach ($sections as $section)
                                        <option value="{{ $section->id }}"
                                            @if ($invoice->section_id == $section->id) selected @endif>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <input type="file" name="invoice_attach[]" class="dropify"
                                accept=".pdf,.jpg, .png, image/jpeg, image/png" data-height="70" multiple />
                        </div><br>
    ...
    <script>
        function myFunction() {
            ...
            if (typeof Amount_Commission === 'undefined' || !Amount_Commission) {
                ...
                var intResults2 = parseFloat(Amount_Commission2 - intResults);
